...
/*********Tune these 4 values for the BOT*********/
...
void setup() {
  ...
  // supply our own gyro offsets here, scaled for min sensitivity
    mpu.setXGyroOffset(22.6);
    mpu.setYGyroOffset(45.5);
    mpu.setZGyroOffset(31.8);
...
//Initialise the Motor outpu pins
 ...
 analogWrite(Motor_right1,LOW);
 analogWrite(Motor_right2,LOW);
 analogWrite(Motor_left2,LOW);
 analogWrite(Motor_left1,LOW);
...
void Forward()
{
  ...
  analogWrite(Motor_left_enable, output);

  digitalWrite(Motor_right1,HIGH);
  digitalWrite(Motor_right2,LOW);
  analogWrite(Motor_right_enable, output);
...

{
  ...
  analogWrite(Motor_left_enable, output*-1);

  digitalWrite(Motor_right1,LOW);
  digitalWrite(Motor_right2,HIGH);
  analogWrite(Motor_right_enable, output*-1);  
